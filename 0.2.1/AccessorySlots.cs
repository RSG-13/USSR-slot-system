...
namespace uniteSlotSystemRemaster.AccessorySlots
{
    ...
    public class BootsAccessorySlot : ModAccessorySlot
    {
        ...
        {
            return Array.IndexOf(uGlobalItemBoots.Items, checkItem.type) != -1;
        }

        public override bool ModifyDefaultSwapSlot(Item item, int accSlotToSwapTo)
        {
            return Array.IndexOf(uGlobalItemBoots.Items, item.type) != -1;
        }
    ...
    public class BuildingAccessSlot : ModAccessorySlot
    {
        ...
        public override bool CanAcceptItem(Item checkItem, AccessorySlotType context)
        {
            return Array.IndexOf(uGlobalItemBuilding.Items, checkItem.type) != -1;
        }

        public override bool ModifyDefaultSwapSlot(Item item, int accSlotToSwapTo)
        {
            return Array.IndexOf(uGlobalItemBuilding.Items, item.type) != -1;
        }
    ...
    public class DefenseAccessorySlot : ModAccessorySlot
    {
        ...
        public override bool CanAcceptItem(Item checkItem, AccessorySlotType context)
        {
            return Array.IndexOf(uGlobalItemDefense.Items, checkItem.type) != -1;
        }

        public override bool ModifyDefaultSwapSlot(Item item, int accSlotToSwapTo)
        {
            return Array.IndexOf(uGlobalItemDefense.Items, item.type) != -1;
        }
    ...
    public class ExpAccessSlot : ModAccessorySlot
    {
        ...
        public override bool CanAcceptItem(Item checkItem, AccessorySlotType context)
        {
            return Array.IndexOf(uGlobalItemExpert.Items, checkItem.type) != -1;
        }

        public override bool ModifyDefaultSwapSlot(Item item, int accSlotToSwapTo)
        {
            return Array.IndexOf(uGlobalItemExpert.Items, item.type) != -1;
        }
    ...
    public class FishingAccessSlot : ModAccessorySlot
    {
        ...
        public override bool CanAcceptItem(Item checkItem, AccessorySlotType context)
        {
            return Array.IndexOf(uGlobalItemFishing.Items, checkItem.type) != -1;
        }

        public override bool ModifyDefaultSwapSlot(Item item, int accSlotToSwapTo)
        {
            return Array.IndexOf(uGlobalItemFishing.Items, item.type) != -1;
        }
    ...
    public class GearAccessorySlot : ModAccessorySlot
    {
        ...
        public override bool CanAcceptItem(Item checkItem, AccessorySlotType context)
        {
            return Array.IndexOf(uGlobalItemGear.Items, checkItem.type) != -1;
        }

        public override bool ModifyDefaultSwapSlot(Item item, int accSlotToSwapTo)
        {
            return Array.IndexOf(uGlobalItemGear.Items, item.type) != -1;
        }
    ...
    public class HealAccessorySlot : ModAccessorySlot
    {
        ...
        public override bool CanAcceptItem(Item checkItem, AccessorySlotType context)
        {
            return Array.IndexOf(uGlobalItemHeal.Items, checkItem.type) != -1;
        }

        public override bool ModifyDefaultSwapSlot(Item item, int accSlotToSwapTo)
        {
            return Array.IndexOf(uGlobalItemHeal.Items, item.type) != -1;
        }
    ...
    public class MagiluminescenceAccessorySlot : ModAccessorySlot
    {
        ...
        public override bool CanAcceptItem(Item checkItem, AccessorySlotType context)
        {
            return Array.IndexOf(uGlobalItemMagiluminescence.Items, checkItem.type) != -1;
        }

        public override bool ModifyDefaultSwapSlot(Item item, int accSlotToSwapTo)
        {
            return Array.IndexOf(uGlobalItemMagiluminescence.Items, item.type) != -1;
        }
    ...
    public class NecklaceAccessorySlot : ModAccessorySlot
    {
        ...
        public override bool CanAcceptItem(Item checkItem, AccessorySlotType context)
        {
            return Array.IndexOf(uGlobalItemNecklace.Items, checkItem.type) != -1;
        }

        public override bool ModifyDefaultSwapSlot(Item item, int accSlotToSwapTo)
        {
            return Array.IndexOf(uGlobalItemNecklace.Items, item.type) != -1;
        }
    ...
    public class RevAccessSlot : ModAccessorySlot
    {
        ...
        public override bool CanAcceptItem(Item checkItem, AccessorySlotType context)
        {
            return Array.IndexOf(uGlobalItemRevengeance.Items, checkItem.type) != -1;
        }

        public override bool ModifyDefaultSwapSlot(Item item, int accSlotToSwapTo)
        {
            return Array.IndexOf(uGlobalItemRevengeance.Items, item.type) != -1;
        }
    ...
    public class ScarfAccessorySlot : ModAccessorySlot
    {
        ...
        public override bool CanAcceptItem(Item checkItem, AccessorySlotType context)
        {
            return Array.IndexOf(uGlobalItemScarf.Items, checkItem.type) != -1;
        }

        public override bool ModifyDefaultSwapSlot(Item item, int accSlotToSwapTo)
        {
            return Array.IndexOf(uGlobalItemScarf.Items, item.type) != -1;
        }
